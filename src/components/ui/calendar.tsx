  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary-600 text-neutral-50 hover:bg-primary-600 hover:text-neutral-50 focus:bg-primary-600 focus:text-neutral-50 dark:bg-primary-500 dark:text-neutral-900 dark:hover:bg-primary-500 dark:hover:text-neutral-900 dark:focus:bg-primary-500 dark:focus:text-neutral-900",
        day_today:
