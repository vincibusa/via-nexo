...
import { APP_CONFIG, SOCIAL_LINKS, LEGAL_LINKS } from "@/constants";
    ...
    <footer className="bg-neutral-900 text-neutral-300">
      <Container className="py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="mb-4 flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-white">Via Nexo</span>
            </div>
            <p className="mb-4 max-w-md text-sm">{APP_CONFIG.description}</p>
            <p className="text-xs text-neutral-400">
              Made with ❤️ for travelers exploring Italy
            </p>
          </div>
        ...
        <div className="mt-8 flex flex-col items-center justify-between border-t border-neutral-800 pt-8 md:flex-row">
          <div className="mb-4 flex flex-wrap items-center gap-6 text-xs text-neutral-400 md:mb-0">
            <span>
